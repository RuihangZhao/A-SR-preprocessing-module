...
parser.add_argument('--pretrained_SR', default='', type=str, help='path to pretrained model (default: none)')
parser.add_argument('--pretrained_TL', default='', type=str, help='path to pretrained model (default: none)')
